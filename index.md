  ...
  <style>
    * { box-sizing: border-box; }
    ...
    .hero {
      ...
      align-items: center;
      background:
        radial-gradient(circle at 8% 10%, rgba(11, 99, 206, 0.12), transparent 28%),
    ...
    .hero-card {
      background:
        radial-gradient(circle at top left, rgba(11, 99, 206, 0.12), transparent 40%),
        #ffffff;
    ...
    .project-card:hover {
      ...
      border-color: #93c5fd;
      box-shadow: 0 24px 70px rgba(11, 99, 206, 0.14);
    }

    .project-title a { color: #0f172a; }
    .project-title a:hover { color: #0b63ce; }
    ...
    @media (max-width: 980px) {
      ...
      .grid, .two-grid, .metric-row, .trusted-row, .map-strip, .location-list { grid-template-columns: 1fr; }
...
<body>
  ...
  <section class="hero">
    <div>
      ...
      <h1>Building AI systems that turn satellite data into <span class="hero-highlight">climate-risk intelligence.</span></h1>
      ...
      <div class="buttons">
        <a class="button primary" href="#systems">Explore AI Systems</a>
        <a class="button" href="https://geospatial-ai-portfolio-3o5dmze6m2y4bc4ktk4zep.streamlit.app" target="_blank" rel="noopener noreferrer">View Live App</a>
        <a class="button" href="mailto:abuitohanosa@gmail.com">Contact Me</a>
      </div>
    </div>

    <div class="hero-visual" aria-label="Portfolio highlights">
      <div class="signal-card">
        <div class="icon-circle">AI</div>
        <div>
          <h3>Geospatial AI Systems</h3>
      ...
      <div class="signal-card">
        ...
        <div>
          <h3>Large-Scale Earth Observation</h3>
      ...
      <div class="signal-card">
        ...
        <div>
          ...
          <p>ResearchGate-listed outputs across remote sensing, environmental monitoring, and land-use change.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="positioning">
    ...
    <div class="trusted-row">
      <div class="trusted-box">University of Würzburg</div>
      <div class="trusted-box">European Commission JRC</div>
      <div class="trusted-box">German Aerospace Center</div>
      <div class="trusted-box">Earth Observation</div>
      <div class="trusted-box">Climate Risk Analytics</div>
    </div>
  </section>
  ...
  <main>
    <section id="systems">
      ...
      <p class="section-lead">
        Selected systems showing how I convert satellite observations, spatial analytics, and AI workflows
    ...
    <section id="global">
      <div class="map-strip">
        ...
        <div class="location-list">
          ...
          <div class="location-pill">Côte d’Ivoire</div>
          <div class="location-pill">Germany</div>
          <div class="location-pill">Italy</div>
          <div class="location-pill">United States</div>
        </div>
      </div>
    </section>
